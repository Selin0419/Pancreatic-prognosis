...
svm_rbf <- ksvm(svm_formula, data = train_data, kernel = "anovadot", 
                kpar = list(sigma = gamma_value, degree = 1), C = 2)
...
km_plot <- ggsurvplot(km_fit, data = test_data,
                      ...
                      title = "Support Vector Machine (ANOVA rbf)",
...
ggsave("SVM_ANOVA_performance.png", plot = km_plot$plot, width = 7, height = 6, units = "in", dpi = 300)
