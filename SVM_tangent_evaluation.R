...
svm_rbf <- ksvm(svm_formula, data = train_data, kernel = "tanhdot", 
                kpar = list(scale = 1, offset = 0), C = C)
# ------------------------------
...
km_plot <- ggsurvplot(km_fit, data = test_data,
                      ...
                      title = "Support Vector Machine (tanh)",
...
ggsave("SVM_tangent_performance.png", plot = km_plot$plot, width = 7, height = 6, units = "in", dpi = 300)
